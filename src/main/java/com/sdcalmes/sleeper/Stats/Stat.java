...
public class Stat
{
    ...
    private double  pass_air_yd;
    private double  penalty_yd;
    private double  rush_yac;
    private double  pass_td_lng;
    private double  bonus_pass_cmp_;
    private double  rush_rz_att;
    private double  pass_rz_att;
    private double  bonus_pass_yd_;
    ...
    public double getPass_air_yd() {
        return pass_air_yd;
    }

    public double getPenalty_yd() {
        return penalty_yd;
    }

    public double getRush_yac() {
        return rush_yac;
    }

    public double getPass_td_lng() {
        return pass_td_lng;
    }

    public double getBonus_pass_cmp_() {
        return bonus_pass_cmp_;
    }

    public double getRush_rz_att() {
        return rush_rz_att;
    }

    public double getPass_rz_att() {
        return pass_rz_att;
    }

    public double getBonus_pass_yd_() {
        return bonus_pass_yd_;
    }
